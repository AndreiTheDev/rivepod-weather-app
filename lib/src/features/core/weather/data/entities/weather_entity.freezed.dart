...
class _$WeatherEntityImpl extends _WeatherEntity {
  ...
  @override
  String toString() {
    return 'WeatherEntity(city: $city, temp: $temp, feelsLike: $feelsLike, pressure: $pressure, humidity: $humidity, windSpeed: $windSpeed, dateTime: $dateTime, description: $description, iconId: $iconId, isMetricUnits: $isMetricUnits)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, city, temp, feelsLike, pressure,
      humidity, windSpeed, dateTime, description, iconId, isMetricUnits);
...
abstract class _WeatherEntity extends WeatherEntity {
  factory _WeatherEntity(
      ...
      required final bool isMetricUnits}) = _$WeatherEntityImpl;
  _WeatherEntity._() : super._();
